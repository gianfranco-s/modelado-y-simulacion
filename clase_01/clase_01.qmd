...
Ecuación Diferencial Ordinaria (ODE, en inglés. Este término es importante)
...
No entraremos en detalles de resolución de esta EDO. Baste con indicar que, si el nivel inicial 
y(t) = U0/k + (y0 - u0/k) e^(-k/A t)

Si consideramos el llenado desde vacío (y0=0)
y(t) = [ 1 - e^(-k/A t)] U0/k

¿Gráfica de esta ecuación?
Cambio de variables:
Normalización: considerar y_hat = y_(U0/k) = 1-e^(-k/At)
A/k = tau
